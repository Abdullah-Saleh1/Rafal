...
export default function Footer() {
  return (
    <footer className="mt-20 border-t border-[#E8E9E9]/10 bg-[#0A291B]">
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-14 md:grid-cols-[1.3fr_0.7fr_1fr_0.9fr] md:px-10" data-aos="fade-up">
        ...
        <div data-aos="fade-up">
          ...
          <div className="flex flex-col gap-3 text-sm text-gray-400">
            ...
            <Link href="/after-sales" className="transition hover:text-white">خدمات ما بعد البيع</Link>
        ...
        <div data-aos="fade-left">
          ...
          <div className="flex flex-col gap-3 text-sm text-gray-400">
            ...
            <a href={company.whatsappHref} target="_blank" rel="noreferrer" className="w-fit font-bold text-[#E8E9E9] transition hover:text-white">تواصل عبر واتساب ↗</a>
        ...
        <div data-aos="fade-left">
          <p className="mb-4 text-sm font-bold text-white">ترخيص رفال</p>
          <img src="/images/رخصة فال.png" alt="رخصة فال رقم 1100004715" className="w-full rounded-2xl border border-[#E8E9E9]/15 bg-white shadow-xl shadow-black/20" />
        </div>
      </div>
