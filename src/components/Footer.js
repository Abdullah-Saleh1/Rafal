...
export default function Footer() {
  return (
    <footer className="mt-20 border-t border-white/10 bg-neutral-950">
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-14 md:grid-cols-[1.3fr_0.7fr_1fr] md:px-10">
        <div>
      ...
      <div className="border-t border-white/10 px-6 py-5 text-center text-xs text-gray-500">© {new Date().getFullYear()} {company.name}. جميع الحقوق محفوظة.</div>
    </footer>
  )
}
